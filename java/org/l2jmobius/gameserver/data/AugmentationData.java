...
{
    // Yüksek ID'li life stone kontrolü
    if (lifeStoneId > 50000)
    {
        // Debug log
        LOGGER.info("High ID Life Stone detected: " + lifeStoneId);
        
        // Life stone ID'sini düşür
        int adjustedStoneId = 8743 + (lifeStoneId % 10); // 8743-8752 aralığına map et
        
        // Grade'e göre offset ekle
        ...
        LOGGER.info("Adjusted Life Stone ID: " + adjustedStoneId);
        lifeStoneId = adjustedStoneId;
    }
