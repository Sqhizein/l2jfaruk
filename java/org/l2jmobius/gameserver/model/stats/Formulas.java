...
public class Formulas
{
	...
	public static double calcHpRegen(Creature creature)
	{
		...
		{
			switch (((Attackable) creature).getChampionType())
			{
				case 1: // Easy
				...
				case 3: // Hard
					...
					break;
				case 4: // Very Hard
					hpRegenMultiplier *= Config.VERY_HARD_CHAMPION_HP_REGEN;
					break;
				case 5: // Catastrophic
					hpRegenMultiplier *= Config.CATASTROPHIC_CHAMPION_HP_REGEN;
					break;
				case 6: // Boss Champion
					hpRegenMultiplier *= Config.BOSS_CHAMPION_HP_REGEN;
					break;
			}
		}
