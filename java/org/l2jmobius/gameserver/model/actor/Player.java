...
public class Player extends Playable
{
	...
	private Map<Stat, Double> _petShare; // Yeni eklenen Pet share map // Faruk Editledi
	...
	public double getServitorShareBonus(Stat stat)
	{
		if (hasPet())
		{
			final Map<Stat, Double> petStats = _petShare;
			if (petStats == null)
			{
				return 1.0d;
			}
			
			final Double val = petStats.get(stat);
			if (val == null)
			{
				return 1.0d;
			}
		...
		{
			final Map<Stat, Double> servitorStats = _servitorShare;
			if (servitorStats == null)
			{
				return 1.0d;
			}
			
			final Double val = servitorStats.get(stat);
			if (val == null)
			{
				return 1.0d;
			}
