...
public class Attackable extends Npc
{
	...
	private int _championType = 0; // 0 = Not Champion, 1 = Easy, 2 = Normal, 3 = Hard, 4 = Very Hard, 5 = Catastrophic, 6 = Boss
					...
					if (attackerParty == null)
					{
						...
						if (isInSurroundingRegion(attacker))
						{
							...
							if (Config.CHAMPION_ENABLE && _champion)
							{
								...
								{
									case 1: // Easy
										exp *= Config.EASY_CHAMPION_REWARDS_EXP_SP;
										sp *= Config.EASY_CHAMPION_REWARDS_EXP_SP;
										break;
									case 2: // Normal (Original)
										...
										break;
									case 3: // Hard
										exp *= Config.HARD_CHAMPION_REWARDS_EXP_SP;
										sp *= Config.HARD_CHAMPION_REWARDS_EXP_SP;
										break;
									case 4: // Very Hard
										exp *= Config.VERY_HARD_CHAMPION_REWARDS_EXP_SP;
										sp *= Config.VERY_HARD_CHAMPION_REWARDS_EXP_SP;
										break;
									case 5: // Catastrophic
										exp *= Config.CATASTROPHIC_CHAMPION_REWARDS_EXP_SP;
										sp *= Config.CATASTROPHIC_CHAMPION_REWARDS_EXP_SP;
										break;
									case 6: // Boss Champion
										exp *= Config.BOSS_CHAMPION_REWARDS_EXP_SP;
										sp *= Config.BOSS_CHAMPION_REWARDS_EXP_SP;
										break;
								}
							}
							exp *= penalty;
	...
	public void setChampion(boolean champ)
{
    ...
    if (_champion)
    {
        // Champion türüne göre görsel efekt uygula
        switch (_championType) // getChampionType() yerine direkt _championType kullanıyoruz
        {
            case 1: // Easy
                startAbnormalVisualEffect(false, AbnormalVisualEffect.VP_KEEP);
                break;
            case 2: // Normal
                startAbnormalVisualEffect(false, AbnormalVisualEffect.BIG_HEAD);
                startAbnormalVisualEffect(false, AbnormalVisualEffect.VP_KEEP);
                break;
            case 3: // Hard
				startAbnormalVisualEffect(false, AbnormalVisualEffect.VP_KEEP);
            ...
            case 5: // Catastrophic
                startAbnormalVisualEffect(false, AbnormalVisualEffect.BIG_HEAD);
				startAbnormalVisualEffect(false, AbnormalVisualEffect.BIG_BODY);
                startAbnormalVisualEffect(false, AbnormalVisualEffect.NAVIT_ADVENT);
				startAbnormalVisualEffect(false, AbnormalVisualEffect.REAL_TARGET);
                break;
            case 6: // Boss Champion
                startAbnormalVisualEffect(false, AbnormalVisualEffect.BIG_HEAD);
                startAbnormalVisualEffect(false, AbnormalVisualEffect.BIG_BODY);
				startAbnormalVisualEffect(false, AbnormalVisualEffect.ULTIMATE_DEFENCE);
				startAbnormalVisualEffect(false, AbnormalVisualEffect.REAL_TARGET);
                break;
        }
    }
    ...
    {
        // Champion değilse tüm efektleri kaldır
        stopAbnormalVisualEffect(false, AbnormalVisualEffect.BIG_HEAD);
        stopAbnormalVisualEffect(false, AbnormalVisualEffect.BIG_BODY);
        stopAbnormalVisualEffect(false, AbnormalVisualEffect.NAVIT_ADVENT);
		stopAbnormalVisualEffect(false, AbnormalVisualEffect.VP_KEEP);
		stopAbnormalVisualEffect(false, AbnormalVisualEffect.ULTIMATE_DEFENCE);
		stopAbnormalVisualEffect(false, AbnormalVisualEffect.REAL_TARGET);
		stopAbnormalVisualEffect(false, AbnormalVisualEffect.TURN_FLEE);
	...
	public void setChampionType(int type)
	{
		_championType = type;
	}
