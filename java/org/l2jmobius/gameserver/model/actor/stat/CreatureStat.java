...
public class CreatureStat
{
	...
	public double getMAtk(Creature target, Skill skill)
	{
		...
		{
			switch (((Attackable) _creature).getChampionType())
			{
				case 1: // Easy
				...
				case 3: // Hard
					...
					break;
				case 4: // Very Hard
					bonusAtk = Config.VERY_HARD_CHAMPION_ATK;
					break;
				case 5: // Catastrophic
					bonusAtk = Config.CATASTROPHIC_CHAMPION_ATK;
					break;
				case 6: // Boss Champion
					bonusAtk = Config.BOSS_CHAMPION_ATK;
					break;
			}
		}
		if (_creature.isRaid())
		...
		if (Config.CHAMPION_ENABLE && _creature.isChampion())
		{
			switch (((Attackable) _creature).getChampionType())
			{
				...
				case 3: // Hard
					...
					break;
				case 4: // Very Hard
					bonusSpdAtk = Config.VERY_HARD_CHAMPION_SPD_ATK;
					break;
				case 5: // Catastrophic
					bonusSpdAtk = Config.CATASTROPHIC_CHAMPION_SPD_ATK;
					break;
				case 6: // Boss Champion
					bonusSpdAtk = Config.BOSS_CHAMPION_SPD_ATK;
					break;
			}
		}
	...
	public double getMDef(Creature target, Skill skill)
	{
		...
		if (Config.CHAMPION_ENABLE && _creature.isChampion())
		{
			...
			{
				case 1: // Easy
					bonusDef = Config.EASY_CHAMPION_MDEF;
					break;
				case 2: // Normal
					bonusDef = Config.CHAMPION_MDEF;
					break;
				case 3: // Hard
					bonusDef = Config.HARD_CHAMPION_MDEF;
					break;
				case 4: // Very Hard
					bonusDef = Config.VERY_HARD_CHAMPION_MDEF;
					break;
				case 5: // Catastrophic
					bonusDef = Config.CATASTROPHIC_CHAMPION_MDEF;
					break;
				case 6: // Boss Champion
					bonusDef = Config.BOSS_CHAMPION_MDEF;
					break;
			}
		}
		if (_creature.isRaid())
		{
			bonusDef *= Config.RAID_MDEFENCE_MULTIPLIER;
		}
		
		return calcStat(Stat.MAGIC_DEFENCE, _creature.getTemplate().getBaseMDef() * bonusDef, target, skill);
	}
	...
	public double getRunSpeed()
	{
		...
		if (Config.CHAMPION_ENABLE && _creature.isChampion())
		{
			...
			{
				case 1: // Easy
					bonusSpeed = Config.EASY_CHAMPION_SPEED;
					break;
				case 2: // Normal
					bonusSpeed = Config.CHAMPION_SPEED;
					break;
				case 3: // Hard
					bonusSpeed = Config.HARD_CHAMPION_SPEED;
					break;
				case 4: // Very Hard
					bonusSpeed = Config.VERY_HARD_CHAMPION_SPEED;
					break;
				case 5: // Catastrophic
					bonusSpeed = Config.CATASTROPHIC_CHAMPION_SPEED;
					break;
				case 6: // Boss Champion
					bonusSpeed = Config.BOSS_CHAMPION_SPEED;
					break;
			}
		}
		...
		return calcStat(Stat.MOVE_SPEED, baseRunSpd * bonusSpeed * _gmSpeedMultiplier, null, null);
	}
	...
	public double getWalkSpeed()
	{
		...
		return calcStat(Stat.MOVE_SPEED, baseWalkSpd * bonusSpeed * _gmSpeedMultiplier);
	}
		...
		if (Config.CHAMPION_ENABLE && _creature.isChampion())
		{
			switch (((Attackable) _creature).getChampionType())
			{
				...
				case 3: // Hard
					...
					break;
				case 4: // Very Hard
					bonusAtk = Config.VERY_HARD_CHAMPION_SPD_ATK;
					break;
				case 5: // Catastrophic
					bonusAtk = Config.CATASTROPHIC_CHAMPION_SPD_ATK;
					break;
				case 6: // Boss Champion
					bonusAtk = Config.BOSS_CHAMPION_SPD_ATK;
					break;
			}
		}
	...
	public double getPDef(Creature target)
	{
		...
		if (Config.CHAMPION_ENABLE && _creature.isChampion())
		{
			...
			{
				case 1: // Easy
					bonusDef = Config.EASY_CHAMPION_PDEF;
					break;
				case 2: // Normal
					bonusDef = Config.CHAMPION_PDEF;
					break;
				case 3: // Hard
					bonusDef = Config.HARD_CHAMPION_PDEF;
					break;
				case 4: // Very Hard
					bonusDef = Config.VERY_HARD_CHAMPION_PDEF;
					break;
				case 5: // Catastrophic
					bonusDef = Config.CATASTROPHIC_CHAMPION_PDEF;
					break;
				case 6: // Boss Champion
					bonusDef = Config.BOSS_CHAMPION_PDEF;
					break;
			}
		}
		if (_creature.isRaid())
		{
			bonusDef *= Config.RAID_PDEFENCE_MULTIPLIER;
		}
		
		return calcStat(Stat.POWER_DEFENCE, _creature.getTemplate().getBasePDef() * bonusDef, target, null);
	}
	...
	public int getAttackElementValue(byte attackAttribute)
	{
		...
		if (Config.CHAMPION_ENABLE && _creature.isChampion())
		{
			...
			{
				case 1: // Easy
					elementBonus = Config.EASY_CHAMPION_ELEMENT_ATK;
					break;
				case 2: // Normal
					elementBonus = Config.CHAMPION_ELEMENT_ATK;
					break;
				case 3: // Hard
					elementBonus = Config.HARD_CHAMPION_ELEMENT_ATK;
					break;
				case 4: // Very Hard
					elementBonus = Config.VERY_HARD_CHAMPION_ELEMENT_ATK;
					break;
				case 5: // Catastrophic
					elementBonus = Config.CATASTROPHIC_CHAMPION_ELEMENT_ATK;
					break;
				case 6: // Boss Champion
					elementBonus = Config.BOSS_CHAMPION_ELEMENT_ATK;
					break;
			}
		}
		...
		switch (attackAttribute)
		{
			case Elementals.FIRE:
				return (int) (calcStat(Stat.FIRE_POWER, _creature.getTemplate().getBaseFire()) * elementBonus);
			case Elementals.WATER:
				return (int) (calcStat(Stat.WATER_POWER, _creature.getTemplate().getBaseWater()) * elementBonus);
			case Elementals.WIND:
				return (int) (calcStat(Stat.WIND_POWER, _creature.getTemplate().getBaseWind()) * elementBonus);
			case Elementals.EARTH:
				return (int) (calcStat(Stat.EARTH_POWER, _creature.getTemplate().getBaseEarth()) * elementBonus);
			case Elementals.HOLY:
				return (int) (calcStat(Stat.HOLY_POWER, _creature.getTemplate().getBaseHoly()) * elementBonus);
			case Elementals.DARK:
				return (int) (calcStat(Stat.DARK_POWER, _creature.getTemplate().getBaseDark()) * elementBonus);
			default:
				return 0;
		}
	}
	...
	public int getDefenseElementValue(byte defenseAttribute)
	{
		...
		if (Config.CHAMPION_ENABLE && _creature.isChampion())
		{
			...
			{
				case 1: // Easy
					elementBonus = Config.EASY_CHAMPION_ELEMENT_DEF;
					break;
				case 2: // Normal
					elementBonus = Config.CHAMPION_ELEMENT_DEF;
					break;
				case 3: // Hard
					elementBonus = Config.HARD_CHAMPION_ELEMENT_DEF;
					break;
				case 4: // Very Hard
					elementBonus = Config.VERY_HARD_CHAMPION_ELEMENT_DEF;
					break;
				case 5: // Catastrophic
					elementBonus = Config.CATASTROPHIC_CHAMPION_ELEMENT_DEF;
					break;
				case 6: // Boss Champion
					elementBonus = Config.BOSS_CHAMPION_ELEMENT_DEF;
					break;
			}
		}
		...
		{
			case Elementals.FIRE:
				return (int) (calcStat(Stat.FIRE_RES, _creature.getTemplate().getBaseFireRes()) * elementBonus);
			case Elementals.WATER:
				return (int) (calcStat(Stat.WATER_RES, _creature.getTemplate().getBaseWaterRes()) * elementBonus);
			case Elementals.WIND:
				return (int) (calcStat(Stat.WIND_RES, _creature.getTemplate().getBaseWindRes()) * elementBonus);
			case Elementals.EARTH:
				return (int) (calcStat(Stat.EARTH_RES, _creature.getTemplate().getBaseEarthRes()) * elementBonus);
			case Elementals.HOLY:
				return (int) (calcStat(Stat.HOLY_RES, _creature.getTemplate().getBaseHolyRes()) * elementBonus);
			case Elementals.DARK:
				return (int) (calcStat(Stat.DARK_RES, _creature.getTemplate().getBaseDarkRes()) * elementBonus);
			default:
				return (int) (_creature.getTemplate().getBaseElementRes() * elementBonus);
		}
	}
