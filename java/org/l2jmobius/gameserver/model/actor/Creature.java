...
public abstract class Creature extends WorldObject implements ISkillsHolder, IDeletable
{
	...
	protected int _currentRHandId;
    protected int _currentLHandId;
	...
	public int getCurrentRHandId()
    {
        return _currentRHandId;
    }
    
    public int getCurrentLHandId()
    {
	...
	public void reduceCurrentHp(double amount, Creature attacker, boolean awake, boolean isDOT, Skill skill)
	{
		...
		{
			switch (((Attackable) this).getChampionType())
			{
				case 1: // Easy
					if (Config.EASY_CHAMPION_HP != 0)
					{
						_status.reduceHp(amount / Config.EASY_CHAMPION_HP, attacker, awake, isDOT, false);
						return;
					}
					break;
				case 2: // Normal
					...
					break;
				case 3: // Hard
					if (Config.HARD_CHAMPION_HP != 0)
					{
						_status.reduceHp(amount / Config.HARD_CHAMPION_HP, attacker, awake, isDOT, false);
						return;
					}
					break;
				case 4: // Very Hard
					if (Config.VERY_HARD_CHAMPION_HP != 0)
					{
						_status.reduceHp(amount / Config.VERY_HARD_CHAMPION_HP, attacker, awake, isDOT, false);
						return;
					}
					break;
				case 5: // Catastrophic
					if (Config.CATASTROPHIC_CHAMPION_HP != 0)
					{
						_status.reduceHp(amount / Config.CATASTROPHIC_CHAMPION_HP, attacker, awake, isDOT, false);
						return;
					}
					break;
				case 6: // Boss Champion
					if (Config.BOSS_CHAMPION_HP != 0)
					{
						_status.reduceHp(amount / Config.BOSS_CHAMPION_HP, attacker, awake, isDOT, false);
						return;
					}
					break;
			}
