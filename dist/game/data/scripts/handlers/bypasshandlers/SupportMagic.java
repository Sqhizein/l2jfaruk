...
public class SupportMagic implements IBypassHandler
{
	...
	private static final int HIGHEST_LEVEL = 86; // 75
	private static final int CUBIC_LOWEST = 1;
	private static final int CUBIC_HIGHEST = 86; // 36
	private static final int HASTE_LEVEL_2 = 1;
	...
	private void makeSupportMagic(Player player, Npc npc, boolean isSummon)
	{
		...
		if (isSummon && !player.hasSummon()) // Sadece hasSummon kontrolü yeterli Faruk Editledi
		{
		...
		// {
		// 	player.sendMessage("Only adventurers who have not completed their 3rd class transfer may receive these buffs."); // Custom message // Sadece hasSummon kontrolü yeterli Faruk Editledi
		// 	return;
		// }
