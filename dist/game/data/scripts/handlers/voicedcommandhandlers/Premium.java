    ...
    public boolean useVoicedCommand(String command, Player activeChar, String target)
    {
        if (command.startsWith("premium") && Config.PREMIUM_SYSTEM_ENABLED)
        {
            ...
            if (endDate == 0)
            {
                ...
                html.append("<tr><td>Sell Rate: <font color=\"LEVEL\"> x1.0<br><br></font></td></tr><br>");
                ...
                html.append("<tr><td>Sell Rate: <font color=\"LEVEL\"> x" + Config.PREMIUM_RATE_SELL_PRICE + "<br1></font></td></tr>");
